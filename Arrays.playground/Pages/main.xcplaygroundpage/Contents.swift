 ...
 */
// write your code here
var cheeseIndex = futureShoppingList.indexOf("Cheese")
futureShoppingList[cheeseIndex!] = "Chicken"
//above line was giving me an error of needing to insert "!" because it is an optional
 ...
 */
// write your code here
func lifesEssential (ingredientsArray: [String]) -> Bool {
    
    if ingredientsArray.indexOf("Bread") == 0 {
        return true
    }
    else {
        return false
